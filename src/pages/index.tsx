  ...
  return (
    <Page>
      <Container maxW="container.lg" mt={8} mb={8}>
        <Image
          src="https://u.tyler.vc/blog-images/index.jpg"
          w="100%"
          alt=""
          mb={8}
        />
          ...
          <Box>
            ...
            <Box mt={6}>
              ...
              <PressPhotoChooser
                ...
                photos={[
                  {
                    image: "/press-photos/press_4_sm.jpg",
                    url: "/press-photos/press_4.jpg",
                    credit: "Eclipse Foundation (CC-ND 2.0)",
                  },
                  {
                    image: "/press-photos/press_1_sm.jpg",
                    url: "/press-photos/press_1.jpg",
                    credit: "Erin Sylvester",
                  },
                  {
                    image: "/press-photos/press_2_sm.jpg",
                    url: "/press-photos/press_2.jpg",
                    credit: "Amelia Bertozzi-Villa",
                  },
                ]}
              />
            </Box>
        ...
        <Grid templateColumns={{ base: "1fr", md: "repeat(3, 1fr)" }} gap={8}>
          ...
          <Box>
            ...
            {cv.grants
              .filter((e) => !e.title!.toLowerCase().includes("submitted"))
